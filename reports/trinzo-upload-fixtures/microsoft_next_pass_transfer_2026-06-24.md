...
- Generated at: 2026-06-24T21:30:19.460197+00:00
...
| `003_webinar_rehearsal` | actions=6, decisions=2, discussionPoints=24 | 1 | expected 0 decisions, got 2 |
...
| `006_product_bug_triage` | actions=1, decisions=1, discussionPoints=4 | 3 | expected 2 actions, got 1<br>expected 0 decisions, got 1<br>missing action 'reproduce it on Safari and capture logs by 3pm' |
...
| `012_training_rollout` | actions=0, decisions=1, discussionPoints=4 | 4 | expected 2 actions, got 0<br>expected 0 decisions, got 1<br>missing action 'split the material into two forty-five minute sessions'<br>missing action 'publish the revised timetable by Thursday' |
...
| `028_customer_onboarding` | actions=0, decisions=1, discussionPoints=3 | 2 | expected 1 actions, got 0<br>missing action 'send the onboarding plan by Friday' |
| `032_training_rollout` | actions=0, decisions=1, discussionPoints=4 | 3 | expected 2 actions, got 0<br>missing action 'split the material into two forty-minute sessions'<br>missing action 'publish the revised timetable by Thursday' |
...
| `038_grant_application_review` | actions=2, decisions=0, discussionPoints=3 | 3 | expected 1 actions, got 2<br>expected 1 decisions, got 0<br>missing decision 'submit the digital-health angle' |
...
| `067_banana_falcon_client_ready` | actions=0, decisions=3, discussionPoints=15 | 4 | expected at least 3 actions, got 0<br>missing action 'work out which dashboard'<br>missing action 'investigate server restart'<br>missing action 'investigate API numbers' |
| `073_support_metrics_actions` | actions=3, decisions=1, discussionPoints=15 | 3 | forbidden content present 'James:'<br>forbidden content present 'Rachel:'<br>forbidden content present 'Mark:' |
