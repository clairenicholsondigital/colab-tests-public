...
- Generated at: 2026-06-24T21:18:57.628459+00:00
...
| `028_customer_onboarding` | actions=1, decisions=0, discussionPoints=2 | 4 | expected 1 decisions, got 0<br>missing discussion topic concepts ['defer SSO until phase two']<br>missing action 'send the onboarding plan by Friday'<br>missing decision 'begin onboarding with CSV import first' |
...
| `073_support_metrics_actions` | actions=3, decisions=0, discussionPoints=15 | 3 | forbidden content present 'James:'<br>forbidden content present 'Rachel:'<br>forbidden content present 'Mark:' |
